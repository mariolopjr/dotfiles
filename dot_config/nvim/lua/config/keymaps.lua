...
map("n", "<leader>Tc", function()
  require("util.coverage").toggle()
end, { desc = "Toggle [C]overage (whole project)" })
map("n", "<leader>TC", function()
  require("util.coverage").toggle_buffer()
end, { desc = "Toggle 󰘶Coverage (this buffer only)" })
map("n", "<leader>Th", function()
  require("util.coverage").toggle_line_highlight()
end, { desc = "Toggle Coverage Line [H]ighlight" })
map("n", "<leader>Tv", function()
  require("util.coverage_summary").open()
end, { desc = "Coverage O[v]erview" })
map("n", "]u", function()
  require("util.coverage").goto_uncovered()
end, { desc = "Next [U]ncovered Line" })
map("n", "[u", function()
  require("util.coverage").goto_uncovered(true)
end, { desc = "Prev [U]ncovered Line" })
