...
M.setup = function()
  ...
  local chezmoi_entry = {
    ...
    key = "c",
    desc = "Config",
    action = require("plugins.chezmoi").pick_chezmoi,
  }
  ...
  map("n", "<leader>gl", Snacks.lazygit.log, { desc = "Lazygit Log (cwd)" })
  ...
  map("n", "<leader>qp", Snacks.picker.projects, { desc = "Projects" })
  ...
  map(
    ...
    { nowait = true, desc = "[G]oto [R]eferences" }
  )
  map(
    "n",
    "gI",
  ...
  end, { desc = "[F]ile [E]xplorer (root dir)" })
  map("n", "<leader>fE", function()
    Snacks.explorer()
  end, { desc = "[F]ile [󰘶E]xplorer (cwd)" })
  map(
    "n",
    "<leader>e",
    "<leader>fe",
    { desc = "[F]ile [E]xplorer (root dir)", remap = true }
  )
  map(
    "n",
    "<leader>E",
    "<leader>fE",
    { desc = "[F]ile [󰘶E]xplorer (cwd)", remap = true }
  )
end
